            ...
            >
              <div>
                ...
                <p style={{ width: '490px', height: '600px' }}>
                  Optimen is a Mexican Software Development company that
                  provides resources management and optimization services to
                  different industries. The company was designated and approved
                  as an International sService Contractor for Jeppesen and
                  Boeing.
                </p>
              </div>
              <hr></hr>
              ...
              <div className="card-body">
                <div className="card-title">
                  ...
                  <p className="card-text text-secondary">
                    Support and facilitate Air Lines around the <br />
            ...
            <div className="column2">
              <div className="card-body">
                <div className="card-title">
                  ...
                  <hr></hr>
                  <p className="card-text text-secondary">
                    To be the First option in Software, Technology <br />
